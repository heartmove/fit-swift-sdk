...
public class DeveloperFieldDefinition: Equatable {
    ...
    public convenience init(stream: InputStream, developerDataLookup: DeveloperDataLookup) throws {
        ...
        guard let developerFieldDefinition = developerDataLookup.getDeveloperFieldDefinition(developerDataIndex: developerDataIndex, fieldDescriptionNumber: fieldDefinitionNumber) else {
