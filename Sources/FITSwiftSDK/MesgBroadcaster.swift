...
public class MesgBroadcaster: MesgListener {
    private var mesgListeners: [ObjectIdentifier: MesgListener] = [:]
    ...
    private var sleepDisruptionSeverityPeriodMesgListeners: [ObjectIdentifier : SleepDisruptionSeverityPeriodMesgListener] = [:]
    private var sleepDisruptionOvernightSeverityMesgListeners: [ObjectIdentifier : SleepDisruptionOvernightSeverityMesgListener] = [:]
    ...
    public func addListener(_ listener: MesgListener) {
        let id = ObjectIdentifier(listener)
        mesgListeners[id] = listener
    }

    public func removeListener(_ listener: MesgListener) {
        let id = ObjectIdentifier(listener)
    ...
    public func addListener(_ listener: SleepDisruptionSeverityPeriodMesgListener) {
        let id = ObjectIdentifier(listener)
        sleepDisruptionSeverityPeriodMesgListeners[id] = listener
    }
    
    public func removeListener(_ listener: SleepDisruptionSeverityPeriodMesgListener) {
        let id = ObjectIdentifier(listener)
        sleepDisruptionSeverityPeriodMesgListeners.removeValue(forKey: id)
    }

    public func addListener(_ listener: SleepDisruptionOvernightSeverityMesgListener) {
        let id = ObjectIdentifier(listener)
        sleepDisruptionOvernightSeverityMesgListeners[id] = listener
    }
    
    public func removeListener(_ listener: SleepDisruptionOvernightSeverityMesgListener) {
        let id = ObjectIdentifier(listener)
        sleepDisruptionOvernightSeverityMesgListeners.removeValue(forKey: id)
    }
    ...
    public func onMesg(_ mesg: Mesg) throws {
        try mesgListeners.values.forEach { try $0.onMesg(mesg) }
        ...
        case .fileId:
            ...
            try self.fileIdMesgListeners.values.forEach { try $0.onMesg(fileIdMesg) }
            return
        case .fileCreator:
            ...
            try self.fileCreatorMesgListeners.values.forEach { try $0.onMesg(fileCreatorMesg) }
            return
        case .timestampCorrelation:
            ...
            try self.timestampCorrelationMesgListeners.values.forEach { try $0.onMesg(timestampCorrelationMesg) }
            return
        case .software:
            ...
            try self.softwareMesgListeners.values.forEach { try $0.onMesg(softwareMesg) }
            return
        case .slaveDevice:
            ...
            try self.slaveDeviceMesgListeners.values.forEach { try $0.onMesg(slaveDeviceMesg) }
            return
        case .capabilities:
            ...
            try self.capabilitiesMesgListeners.values.forEach { try $0.onMesg(capabilitiesMesg) }
            return
        case .fileCapabilities:
            ...
            try self.fileCapabilitiesMesgListeners.values.forEach { try $0.onMesg(fileCapabilitiesMesg) }
            return
        case .mesgCapabilities:
            ...
            try self.mesgCapabilitiesMesgListeners.values.forEach { try $0.onMesg(mesgCapabilitiesMesg) }
            return
        case .fieldCapabilities:
            ...
            try self.fieldCapabilitiesMesgListeners.values.forEach { try $0.onMesg(fieldCapabilitiesMesg) }
            return
        case .deviceSettings:
            ...
            try self.deviceSettingsMesgListeners.values.forEach { try $0.onMesg(deviceSettingsMesg) }
            return
        case .userProfile:
            ...
            try self.userProfileMesgListeners.values.forEach { try $0.onMesg(userProfileMesg) }
            return
        case .hrmProfile:
            ...
            try self.hrmProfileMesgListeners.values.forEach { try $0.onMesg(hrmProfileMesg) }
            return
        case .sdmProfile:
            ...
            try self.sdmProfileMesgListeners.values.forEach { try $0.onMesg(sdmProfileMesg) }
            return
        case .bikeProfile:
            ...
            try self.bikeProfileMesgListeners.values.forEach { try $0.onMesg(bikeProfileMesg) }
            return
        case .connectivity:
            ...
            try self.connectivityMesgListeners.values.forEach { try $0.onMesg(connectivityMesg) }
            return
        case .watchfaceSettings:
            ...
            try self.watchfaceSettingsMesgListeners.values.forEach { try $0.onMesg(watchfaceSettingsMesg) }
            return
        case .ohrSettings:
            ...
            try self.ohrSettingsMesgListeners.values.forEach { try $0.onMesg(ohrSettingsMesg) }
            return
        case .timeInZone:
            ...
            try self.timeInZoneMesgListeners.values.forEach { try $0.onMesg(timeInZoneMesg) }
            return
        case .zonesTarget:
            ...
            try self.zonesTargetMesgListeners.values.forEach { try $0.onMesg(zonesTargetMesg) }
            return
        case .sport:
            ...
            try self.sportMesgListeners.values.forEach { try $0.onMesg(sportMesg) }
            return
        case .hrZone:
            ...
            try self.hrZoneMesgListeners.values.forEach { try $0.onMesg(hrZoneMesg) }
            return
        case .speedZone:
            ...
            try self.speedZoneMesgListeners.values.forEach { try $0.onMesg(speedZoneMesg) }
            return
        case .cadenceZone:
            ...
            try self.cadenceZoneMesgListeners.values.forEach { try $0.onMesg(cadenceZoneMesg) }
            return
        case .powerZone:
            ...
            try self.powerZoneMesgListeners.values.forEach { try $0.onMesg(powerZoneMesg) }
            return
        case .metZone:
            ...
            try self.metZoneMesgListeners.values.forEach { try $0.onMesg(metZoneMesg) }
            return
        case .trainingSettings:
            ...
            try self.trainingSettingsMesgListeners.values.forEach { try $0.onMesg(trainingSettingsMesg) }
            return
        case .diveSettings:
            ...
            try self.diveSettingsMesgListeners.values.forEach { try $0.onMesg(diveSettingsMesg) }
            return
        case .diveAlarm:
            ...
            try self.diveAlarmMesgListeners.values.forEach { try $0.onMesg(diveAlarmMesg) }
            return
        case .diveApneaAlarm:
            ...
            try self.diveApneaAlarmMesgListeners.values.forEach { try $0.onMesg(diveApneaAlarmMesg) }
            return
        case .diveGas:
            ...
            try self.diveGasMesgListeners.values.forEach { try $0.onMesg(diveGasMesg) }
            return
        case .goal:
            ...
            try self.goalMesgListeners.values.forEach { try $0.onMesg(goalMesg) }
            return
        case .activity:
            ...
            try self.activityMesgListeners.values.forEach { try $0.onMesg(activityMesg) }
            return
        case .session:
            ...
            try self.sessionMesgListeners.values.forEach { try $0.onMesg(sessionMesg) }
            return
        case .lap:
            ...
            try self.lapMesgListeners.values.forEach { try $0.onMesg(lapMesg) }
            return
        case .length:
            ...
            try self.lengthMesgListeners.values.forEach { try $0.onMesg(lengthMesg) }
            return
        case .record:
            ...
            try self.recordMesgListeners.values.forEach { try $0.onMesg(recordMesg) }
            return
        case .event:
            ...
            try self.eventMesgListeners.values.forEach { try $0.onMesg(eventMesg) }
            return
        case .deviceInfo:
            ...
            try self.deviceInfoMesgListeners.values.forEach { try $0.onMesg(deviceInfoMesg) }
            return
        case .deviceAuxBatteryInfo:
            ...
            try self.deviceAuxBatteryInfoMesgListeners.values.forEach { try $0.onMesg(deviceAuxBatteryInfoMesg) }
            return
        case .trainingFile:
            ...
            try self.trainingFileMesgListeners.values.forEach { try $0.onMesg(trainingFileMesg) }
            return
        case .weatherConditions:
            ...
            try self.weatherConditionsMesgListeners.values.forEach { try $0.onMesg(weatherConditionsMesg) }
            return
        case .weatherAlert:
            ...
            try self.weatherAlertMesgListeners.values.forEach { try $0.onMesg(weatherAlertMesg) }
            return
        case .gpsMetadata:
            ...
            try self.gpsMetadataMesgListeners.values.forEach { try $0.onMesg(gpsMetadataMesg) }
            return
        case .cameraEvent:
            ...
            try self.cameraEventMesgListeners.values.forEach { try $0.onMesg(cameraEventMesg) }
            return
        case .gyroscopeData:
            ...
            try self.gyroscopeDataMesgListeners.values.forEach { try $0.onMesg(gyroscopeDataMesg) }
            return
        case .accelerometerData:
            ...
            try self.accelerometerDataMesgListeners.values.forEach { try $0.onMesg(accelerometerDataMesg) }
            return
        case .magnetometerData:
            ...
            try self.magnetometerDataMesgListeners.values.forEach { try $0.onMesg(magnetometerDataMesg) }
            return
        case .barometerData:
            ...
            try self.barometerDataMesgListeners.values.forEach { try $0.onMesg(barometerDataMesg) }
            return
        case .threeDSensorCalibration:
            ...
            try self.threeDSensorCalibrationMesgListeners.values.forEach { try $0.onMesg(threeDSensorCalibrationMesg) }
            return
        case .oneDSensorCalibration:
            ...
            try self.oneDSensorCalibrationMesgListeners.values.forEach { try $0.onMesg(oneDSensorCalibrationMesg) }
            return
        case .videoFrame:
            ...
            try self.videoFrameMesgListeners.values.forEach { try $0.onMesg(videoFrameMesg) }
            return
        case .obdiiData:
            ...
            try self.obdiiDataMesgListeners.values.forEach { try $0.onMesg(obdiiDataMesg) }
            return
        case .nmeaSentence:
            ...
            try self.nmeaSentenceMesgListeners.values.forEach { try $0.onMesg(nmeaSentenceMesg) }
            return
        case .aviationAttitude:
            ...
            try self.aviationAttitudeMesgListeners.values.forEach { try $0.onMesg(aviationAttitudeMesg) }
            return
        case .video:
            ...
            try self.videoMesgListeners.values.forEach { try $0.onMesg(videoMesg) }
            return
        case .videoTitle:
            ...
            try self.videoTitleMesgListeners.values.forEach { try $0.onMesg(videoTitleMesg) }
            return
        case .videoDescription:
            ...
            try self.videoDescriptionMesgListeners.values.forEach { try $0.onMesg(videoDescriptionMesg) }
            return
        case .videoClip:
            ...
            try self.videoClipMesgListeners.values.forEach { try $0.onMesg(videoClipMesg) }
            return
        case .set:
            ...
            try self.setMesgListeners.values.forEach { try $0.onMesg(setMesg) }
            return
        case .jump:
            ...
            try self.jumpMesgListeners.values.forEach { try $0.onMesg(jumpMesg) }
            return
        case .split:
            ...
            try self.splitMesgListeners.values.forEach { try $0.onMesg(splitMesg) }
            return
        case .splitSummary:
            ...
            try self.splitSummaryMesgListeners.values.forEach { try $0.onMesg(splitSummaryMesg) }
            return
        case .climbPro:
            ...
            try self.climbProMesgListeners.values.forEach { try $0.onMesg(climbProMesg) }
            return
        case .fieldDescription:
            ...
            try self.fieldDescriptionMesgListeners.values.forEach { try $0.onMesg(fieldDescriptionMesg) }
            return
        case .developerDataId:
            ...
            try self.developerDataIdMesgListeners.values.forEach { try $0.onMesg(developerDataIdMesg) }
            return
        case .course:
            ...
            try self.courseMesgListeners.values.forEach { try $0.onMesg(courseMesg) }
            return
        case .coursePoint:
            ...
            try self.coursePointMesgListeners.values.forEach { try $0.onMesg(coursePointMesg) }
            return
        case .segmentId:
            ...
            try self.segmentIdMesgListeners.values.forEach { try $0.onMesg(segmentIdMesg) }
            return
        case .segmentLeaderboardEntry:
            ...
            try self.segmentLeaderboardEntryMesgListeners.values.forEach { try $0.onMesg(segmentLeaderboardEntryMesg) }
            return
        case .segmentPoint:
            ...
            try self.segmentPointMesgListeners.values.forEach { try $0.onMesg(segmentPointMesg) }
            return
        case .segmentLap:
            ...
            try self.segmentLapMesgListeners.values.forEach { try $0.onMesg(segmentLapMesg) }
            return
        case .segmentFile:
            ...
            try self.segmentFileMesgListeners.values.forEach { try $0.onMesg(segmentFileMesg) }
            return
        case .workout:
            ...
            try self.workoutMesgListeners.values.forEach { try $0.onMesg(workoutMesg) }
            return
        case .workoutSession:
            ...
            try self.workoutSessionMesgListeners.values.forEach { try $0.onMesg(workoutSessionMesg) }
            return
        case .workoutStep:
            ...
            try self.workoutStepMesgListeners.values.forEach { try $0.onMesg(workoutStepMesg) }
            return
        case .exerciseTitle:
            ...
            try self.exerciseTitleMesgListeners.values.forEach { try $0.onMesg(exerciseTitleMesg) }
            return
        case .schedule:
            ...
            try self.scheduleMesgListeners.values.forEach { try $0.onMesg(scheduleMesg) }
            return
        case .totals:
            ...
            try self.totalsMesgListeners.values.forEach { try $0.onMesg(totalsMesg) }
            return
        case .weightScale:
            ...
            try self.weightScaleMesgListeners.values.forEach { try $0.onMesg(weightScaleMesg) }
            return
        case .bloodPressure:
            ...
            try self.bloodPressureMesgListeners.values.forEach { try $0.onMesg(bloodPressureMesg) }
            return
        case .monitoringInfo:
            ...
            try self.monitoringInfoMesgListeners.values.forEach { try $0.onMesg(monitoringInfoMesg) }
            return
        case .monitoring:
            ...
            try self.monitoringMesgListeners.values.forEach { try $0.onMesg(monitoringMesg) }
            return
        case .monitoringHrData:
            ...
            try self.monitoringHrDataMesgListeners.values.forEach { try $0.onMesg(monitoringHrDataMesg) }
            return
        case .spo2Data:
            ...
            try self.spo2DataMesgListeners.values.forEach { try $0.onMesg(spo2DataMesg) }
            return
        case .hr:
            ...
            try self.hrMesgListeners.values.forEach { try $0.onMesg(hrMesg) }
            return
        case .stressLevel:
            ...
            try self.stressLevelMesgListeners.values.forEach { try $0.onMesg(stressLevelMesg) }
            return
        case .maxMetData:
            ...
            try self.maxMetDataMesgListeners.values.forEach { try $0.onMesg(maxMetDataMesg) }
            return
        case .hsaBodyBatteryData:
            ...
            try self.hsaBodyBatteryDataMesgListeners.values.forEach { try $0.onMesg(hsaBodyBatteryDataMesg) }
            return
        case .hsaEvent:
            ...
            try self.hsaEventMesgListeners.values.forEach { try $0.onMesg(hsaEventMesg) }
            return
        case .hsaAccelerometerData:
            ...
            try self.hsaAccelerometerDataMesgListeners.values.forEach { try $0.onMesg(hsaAccelerometerDataMesg) }
            return
        case .hsaGyroscopeData:
            ...
            try self.hsaGyroscopeDataMesgListeners.values.forEach { try $0.onMesg(hsaGyroscopeDataMesg) }
            return
        case .hsaStepData:
            ...
            try self.hsaStepDataMesgListeners.values.forEach { try $0.onMesg(hsaStepDataMesg) }
            return
        case .hsaSpo2Data:
            ...
            try self.hsaSpo2DataMesgListeners.values.forEach { try $0.onMesg(hsaSpo2DataMesg) }
            return
        case .hsaStressData:
            ...
            try self.hsaStressDataMesgListeners.values.forEach { try $0.onMesg(hsaStressDataMesg) }
            return
        case .hsaRespirationData:
            ...
            try self.hsaRespirationDataMesgListeners.values.forEach { try $0.onMesg(hsaRespirationDataMesg) }
            return
        case .hsaHeartRateData:
            ...
            try self.hsaHeartRateDataMesgListeners.values.forEach { try $0.onMesg(hsaHeartRateDataMesg) }
            return
        case .hsaConfigurationData:
            ...
            try self.hsaConfigurationDataMesgListeners.values.forEach { try $0.onMesg(hsaConfigurationDataMesg) }
            return
        case .hsaWristTemperatureData:
            ...
            try self.hsaWristTemperatureDataMesgListeners.values.forEach { try $0.onMesg(hsaWristTemperatureDataMesg) }
            return
        case .memoGlob:
            ...
            try self.memoGlobMesgListeners.values.forEach { try $0.onMesg(memoGlobMesg) }
            return
        case .sleepLevel:
            ...
            try self.sleepLevelMesgListeners.values.forEach { try $0.onMesg(sleepLevelMesg) }
            return
        case .antChannelId:
            ...
            try self.antChannelIdMesgListeners.values.forEach { try $0.onMesg(antChannelIdMesg) }
            return
        case .antRx:
            ...
            try self.antRxMesgListeners.values.forEach { try $0.onMesg(antRxMesg) }
            return
        case .antTx:
            ...
            try self.antTxMesgListeners.values.forEach { try $0.onMesg(antTxMesg) }
            return
        case .exdScreenConfiguration:
            ...
            try self.exdScreenConfigurationMesgListeners.values.forEach { try $0.onMesg(exdScreenConfigurationMesg) }
            return
        case .exdDataFieldConfiguration:
            ...
            try self.exdDataFieldConfigurationMesgListeners.values.forEach { try $0.onMesg(exdDataFieldConfigurationMesg) }
            return
        case .exdDataConceptConfiguration:
            ...
            try self.exdDataConceptConfigurationMesgListeners.values.forEach { try $0.onMesg(exdDataConceptConfigurationMesg) }
            return
        case .diveSummary:
            ...
            try self.diveSummaryMesgListeners.values.forEach { try $0.onMesg(diveSummaryMesg) }
            return
        case .aadAccelFeatures:
            ...
            try self.aadAccelFeaturesMesgListeners.values.forEach { try $0.onMesg(aadAccelFeaturesMesg) }
            return
        case .hrv:
            ...
            try self.hrvMesgListeners.values.forEach { try $0.onMesg(hrvMesg) }
            return
        case .beatIntervals:
            ...
            try self.beatIntervalsMesgListeners.values.forEach { try $0.onMesg(beatIntervalsMesg) }
            return
        case .hrvStatusSummary:
            ...
            try self.hrvStatusSummaryMesgListeners.values.forEach { try $0.onMesg(hrvStatusSummaryMesg) }
            return
        case .hrvValue:
            ...
            try self.hrvValueMesgListeners.values.forEach { try $0.onMesg(hrvValueMesg) }
            return
        case .rawBbi:
            ...
            try self.rawBbiMesgListeners.values.forEach { try $0.onMesg(rawBbiMesg) }
            return
        case .respirationRate:
            ...
            try self.respirationRateMesgListeners.values.forEach { try $0.onMesg(respirationRateMesg) }
            return
        case .chronoShotSession:
            ...
            try self.chronoShotSessionMesgListeners.values.forEach { try $0.onMesg(chronoShotSessionMesg) }
            return
        case .chronoShotData:
            ...
            try self.chronoShotDataMesgListeners.values.forEach { try $0.onMesg(chronoShotDataMesg) }
            return
        case .tankUpdate:
            ...
            try self.tankUpdateMesgListeners.values.forEach { try $0.onMesg(tankUpdateMesg) }
            return
        case .tankSummary:
            ...
            try self.tankSummaryMesgListeners.values.forEach { try $0.onMesg(tankSummaryMesg) }
            return
        case .sleepAssessment:
            ...
            try self.sleepAssessmentMesgListeners.values.forEach { try $0.onMesg(sleepAssessmentMesg) }
            return
        case .sleepDisruptionSeverityPeriod:
            if (self.sleepDisruptionSeverityPeriodMesgListeners.count == 0) {
                return
            }

            let sleepDisruptionSeverityPeriodMesg = SleepDisruptionSeverityPeriodMesg(mesg: mesg)
            try self.sleepDisruptionSeverityPeriodMesgListeners.values.forEach { try $0.onMesg(sleepDisruptionSeverityPeriodMesg) }
            return
        case .sleepDisruptionOvernightSeverity:
            if (self.sleepDisruptionOvernightSeverityMesgListeners.count == 0) {
                return
            }

            let sleepDisruptionOvernightSeverityMesg = SleepDisruptionOvernightSeverityMesg(mesg: mesg)
            try self.sleepDisruptionOvernightSeverityMesgListeners.values.forEach { try $0.onMesg(sleepDisruptionOvernightSeverityMesg) }
            return
        case .skinTempOvernight:
            ...
            try self.skinTempOvernightMesgListeners.values.forEach { try $0.onMesg(skinTempOvernightMesg) }
            return
        case .pad:
            ...
            try self.padMesgListeners.values.forEach { try $0.onMesg(padMesg) }
            return
        default:
            return
        }
