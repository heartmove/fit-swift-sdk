...
public struct FIT: Sendable {
    ...
    public static let PROFILE_MINOR_VERSION: UInt16 = 184
...
public enum ProtocolVersion: UInt8, Sendable {
    case invalid = 0x00
    case v10 = 0x10
    case v20 = 0x20
}

public enum Endianness: UInt8, Sendable {
    case little = 0
    case big = 1
}

public enum LocalMesgNum: UInt8, Sendable {
    case zero = 0
    case one = 1
    case two = 2
    case three = 3
