...
public class MesgDefinition: Equatable {
    ...
    public init(stream: InputStream, developerDataLookup: DeveloperDataLookup) throws {
        ...
        if ((recordHeader & FIT.DEV_DATA_MASK) == FIT.DEV_DATA_MASK) {
            ...
            for _ in 0..<numDevFields {
                try developerFieldDefinitions.append(DeveloperFieldDefinition(stream: stream, developerDataLookup: developerDataLookup))
            }
        }
    }
