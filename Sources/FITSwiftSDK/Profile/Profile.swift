...
public struct Profile {
    ...
    public enum ProfileType: CaseIterable, Sendable
    {
        // Base Types
        case `enum`
        case sint8
    ...
    public struct MesgNum: Sendable {
	    ...
	    public static let sleepDisruptionSeverityPeriod: MesgNumber = 470
	    public static let sleepDisruptionOvernightSeverity: MesgNumber = 471
