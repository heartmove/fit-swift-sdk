...
public class Decoder: MesgSource, MesgDefinitionSource {
    ...
    private func decodeMessageDefinition() throws -> Void {
        let mesgDefinition = try MesgDefinition(stream: stream, developerDataLookup: developerDataLookup)
        localMesgDefinitions[mesgDefinition.localMesgNum] = mesgDefinition
        
        try broadcastMesgDefinition(mesgDefinition)
    }
    ...
    func broadcastMesg(_ mesg: Mesg) throws {
        for (id, mesgListenerWeakRef) in mesgListeners {
            ...
            try mesgListener.onMesg(Mesg(mesg: mesg))
        }
    }
    ...
    func broadcastMesgDefinition(_ mesgDefinition: MesgDefinition) throws {
        for (id, mesgDefinitionListenerWeakRef) in mesgDefinitionListeners {
            ...
            try mesgDefinitionListener.onMesgDefinition(mesgDefinition)
        }
    }
